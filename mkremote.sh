...
# XXX: _lwp.o isn't really in the right place, but works for now
${CC} ${CFLAGS} ${OBJDIR}/tmp2_${NAME}.o _lwp.o emul.o rumpclient.o remoteinit.o ${RUMPCLIENT} ${DLFLAG} -o ${BINDIR}/${NAME}
