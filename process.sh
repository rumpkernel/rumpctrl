...
${CC} -Wl,-r ${OBJDIR}/tmp0_${NAME}.o -nostdlib rump/lib/libc.a -o ${OBJDIR}/tmp1_${NAME}.o
...
${CC} -Wl,-r -nostdlib -Wl,-dc ${OBJDIR}/tmp1_${NAME}.o readwrite.o -o ${OBJDIR}/tmp2_${NAME}.o
