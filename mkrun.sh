...
RUMPLIBS="-L${LIBRARY_PATH} -Wl,-R${LIBRARY_PATH} -Wl,--no-as-needed -lrumpvfs -lrumpfs_kernfs -lrumpfs_ffs -lrumpdev_disk -lrumpdev -lrumpnet -lrumpnet_net -lrumpnet_netinet -lrumpnet_netinet6 -lrumpuser -lrump"
